...
<div class="factoid factoid-bottom">
  <a href="/lispress/2-blog-engine/">Следующая статья.</a>
  О выборе технологии для блога. Много технических подробностей, выбор между Hugo, Ghost и Wordpress.
  <br>
  <br>
  Если не интересны технические подробности, можете перейти <a href="/lispress/3-main-design">к статье про дизайн</a>.
  <br>
  <br>
  Или <a href="/lispress/4-happy-end">в конец проекта</a> и узнать, как появился этот блог и почему
  по адресу <a href="lis.press">lis.press</a> находится что-то странное.
</div>
